...
extension RangeAuthoredLexer {
    static let generatedRules: [RangeAuthoredLexerRule] = [
        ...
        RangeAuthoredLexerRule(name: "hashDirective", pattern: "#identifier", token: "hashDirective", priority: 40),
        RangeAuthoredLexerRule(name: "hash", pattern: "#(", token: "hash", priority: 50),
        RangeAuthoredLexerRule(name: "atAttribute", pattern: "@identifier", token: "atAttribute", priority: 40),
