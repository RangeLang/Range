    ...
    func intBufferUsesSharedExternalRuntimeABI() throws {
        let module = try emit(
            ...
            @main {
                ...
                intBufferSet(buffer: buffer, index: 1, value: 13)
        ...
        #expect(module.contains("declare i32 @intBufferSet(ptr, i32, i32)"))
        ...
        #expect(module.contains("call i32 @intBufferSet(ptr"))
