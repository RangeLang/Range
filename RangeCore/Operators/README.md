...
Range operators are declared explicitly as language features, following Swift's operator model. Operator declaration, precedence, and implementation are separate concerns.

## Role

Operators should be part of Range's language-visible surface rather than permanently hardcoded inside the Swift-hosted compiler.

This gives Range a clear place to define operator names, fixity, precedence relationships, and eventually operator-backed protocol and function behavior.
...
- Range is targeting an explicit Swift-style operator declaration model.
...
- Future operator meaning should come from Range declarations and callable/protocol rules rather than ad hoc Swift enums.
