...
const worker = {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/globals.css" || url.pathname === "/range-geist.css" || url.pathname === "/range-ui.css" || url.pathname === "/range-ui-v98.css") {
    ...
    if (rendered) {
      const html = rendered.html
        ...
        .replace('endpoint-gap="8"', 'endpoint-gap="8" endpoint-gap-end="14"')
