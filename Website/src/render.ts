...
function home(data: BenchmarkData): string {
  return `<range-home-page><main class="landingPage"><div class="landingSequence"><header class="landingNav"><a class="landingWordmark" href="/"><span class="landingIndex" data-scale-zero>0</span><span class="rangeWord">Range</span></a><range-spline-nav role="navigation" aria-label="Primary navigation"><a href="/benchmarks">Benchmarks</a><a href="/updates/string-lowering">Updates</a><a href="${githubUrl}" target="_blank" rel="noreferrer">GitHub</a></range-spline-nav></header><range-scale aria-hidden="true" endpoint-gap="8" endpoint-gap-end="16" division-base="3" division-levels="3" pinch="0.27" pinch-core="10" pinch-falloff="0.16" pinch-inner-edge="0.68" pinch-strength="0.9" measure-minimum="0.7" invisible-collapse-power="1.35" invisible-measure-minimum="0.1" invisible-stroke-minimum="0.06" marker-capture-division-weight="0.48" marker-capture-falloff="0.14" marker-capture-strength="0.9" stroke-minimum="0.65" snap-hysteresis="0.08" snap-to-marks="true" tone-falloff="0.12" tone-intensity="0.16"></range-scale><range-optical-guide aria-hidden="true"></range-optical-guide><section class="landingHero" aria-labelledby="range-title"><h1 id="range-title"><span class="landingIndex" data-scale-end><span>1</span></span><span class="rangeTitleWord">Range</span><span class="rangePerformanceAnchor" aria-hidden="true"></span></h1><div class="landingSupport"><p>a love letter to electrons, logic and abstraction</p><div class="landingActions"><a class="primaryAction" href="/benchmarks">Benchmarks</a><a class="secondaryAction" href="${githubUrl}" target="_blank" rel="noreferrer">${githubIcon()}GitHub</a></div></div></section></div><section class="landingLinks" aria-label="Range links"><a href="/benchmarks"><span><strong>Benchmarks</strong><small>${data.summary.runLeafCount} generated comparisons</small></span><span>View</span></a><a href="/updates/string-lowering"><span><strong>String lowering</strong><small>100k appends · 491.2 ms → 4.1 ms</small></span><span>View</span></a></section></main></range-home-page>`;
}
