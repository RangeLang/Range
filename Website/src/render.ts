...
function home(data: BenchmarkData): string {
  return `<range-home-page><main class="landingPage"><div class="landingSequence"><header class="landingNav"><a class="landingWordmark" href="/"><span class="landingIndex" data-scale-zero>0</span><span class="rangeWord">Range</span></a><nav aria-label="Primary navigation"><a href="/benchmarks">Benchmarks</a><a href="/updates/string-lowering">Updates</a><a href="${githubUrl}" target="_blank" rel="noreferrer">GitHub</a></nav></header><range-scale aria-hidden="true" endpoint-gap="8" division-base="3" division-levels="3" pinch="0.27" pinch-core="10" pinch-falloff="0.16" pinch-inner-edge="0.68" pinch-strength="0.9" measure-minimum="0.35" invisible-collapse-power="1.35" invisible-measure-minimum="0.1" invisible-stroke-minimum="0.06" marker-capture-division-weight="0.48" marker-capture-falloff="0.14" marker-capture-strength="0.9" stroke-minimum="0.25" snap-hysteresis="0.08" snap-to-marks="true" tone-falloff="0.12" tone-intensity="0.82"></range-scale><range-optical-guide aria-hidden="true"></range-optical-guide><section class="landingHero" aria-labelledby="range-title"><h1 id="range-title"><span class="landingIndex" data-scale-end><span>1</span></span><span class="rangeTitleWord">Range</span></h1><p>The active compiler is Range-authored and emits native LLVM.</p><div class="landingActions"><a class="primaryAction" href="/benchmarks">Benchmarks</a><a class="secondaryAction" href="${githubUrl}" target="_blank" rel="noreferrer">${githubIcon()}GitHub</a></div></section></div><section class="landingLinks" aria-label="Range links"><a href="/benchmarks"><span><strong>Benchmarks</strong><small>${data.summary.runLeafCount} generated comparisons</small></span><span>View</span></a><a href="/updates/string-lowering"><span><strong>String lowering</strong><small>100k appends · 491.2 ms → 4.1 ms</small></span><span>View</span></a></section></main></range-home-page>`;
}
...
function documentShell(content: string): string {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Range</title><meta name="description" content="Native benchmark results for Range, C, C++, Rust, Go, and Swift, with compiler emission status."><meta property="og:title" content="Range"><meta property="og:description" content="Native benchmark results for Range, C, C++, Rust, Go, and Swift, with compiler emission status."><meta property="og:type" content="website"><meta property="og:image" content="/og-v3.png"><meta name="twitter:card" content="summary_large_image"><link rel="icon" href="/favicon.svg"><link rel="stylesheet" href="/globals.css?font=avio-sans-v1"><script type="module" src="/range-site.js"></script><script type="module" src="/range-scale.js?profile=anchored-endpoints"></script><script type="module" src="/range-optical-guide.js?guide=glyph-ink-box"></script><script type="module" src="/range-typed-text.js"></script></head><body><range-site-shell>${content}</range-site-shell></body></html>`;
}
