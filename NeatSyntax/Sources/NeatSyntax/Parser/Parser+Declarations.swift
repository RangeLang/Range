...
extension Parser {
    ...
    mutating func parseBuilderDeclaration(requiresEOF: Bool = true) throws -> DeclarationNode {
    ...
    func validateBuilderDeclarations(in declarations: [DeclarationNode]) throws {
